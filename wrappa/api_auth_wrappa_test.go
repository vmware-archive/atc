	...
	Describe("Wrap", func() {
		...
		BeforeEach(func() {
			...
			expectedHandlers = rata.Handlers{
				...
				atc.ListCheckContainers:         authenticated(inputHandlers[atc.ListCheckContainers]),
				atc.ListCheckContainersDetailed: authenticated(inputHandlers[atc.ListCheckContainersDetailed]),
