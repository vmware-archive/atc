...
func (fake *FakeGetDelegate) Finished(arg1 lager.Logger, arg2 runtime.ExitStatus, arg3 exec.VersionInfo) {
...
func (fake *FakeGetDelegate) FinishedArgsForCall(i int) (lager.Logger, runtime.ExitStatus, exec.VersionInfo) {
	fake.finishedMutex.RLock()
	defer fake.finishedMutex.RUnlock()
