...
type FakeResourceConfigCheckSession struct {
	...
	ResourceConfigStub        func() db.ResourceConfigVVV
...
func (fake *FakeResourceConfigCheckSession) ResourceConfig() db.ResourceConfigVVV {
...
func (fake *FakeResourceConfigCheckSession) ResourceConfigReturns(result1 db.ResourceConfigVVV) {
...
func (fake *FakeResourceConfigCheckSession) ResourceConfigReturnsOnCall(i int, result1 db.ResourceConfigVVV) {
	fake.ResourceConfigStub = nil
