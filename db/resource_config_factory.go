...
func (f *resourceConfigFactory) FindResourceConfig(
	...
	var resourceConfig ResourceConfigVVV
	...
	resourceConfig, found, err := resourceConfigDescriptor.Find(tx)
	if err != nil {
		return nil, false, err
	}
...
func constructResourceConfigDescriptor(
	...
	if found {
		...
		resourceConfigDescriptor.CreatedByResourceCache = &ResourceCache{
