...
Elm.Build.make = function (_elm) {
   ...
   var viewBuildHeader = F3(function (actions,build,_p1) {
      ...
      var buildTitle = function () {
         ...
         if (_p3.ctor === "Just") {
               ...
               "/pipelines/",
               A2($Basics._op["++"],_p3._0.pipelineName,A2($Basics._op["++"],"/jobs/",_p4))))]),
               _U.list([$Html.text(A2($Basics._op["++"],_p4,A2($Basics._op["++"]," #",build.name)))]));
            } else {
      ...
      var triggerButton = function () {
         ...
         if (_p5.ctor === "Just") {
               ...
               "/pipelines/",
               A2($Basics._op["++"],_p5._0.pipelineName,A2($Basics._op["++"],"/jobs/",A2($Basics._op["++"],_p5._0.name,"/builds"))));
               return A2($Html.form,
      ...
      return A2($Html.div,
      _U.list([$Html$Attributes.id("page-header"),$Html$Attributes.$class($Concourse$BuildStatus.show(_p6))]),
      _U.list([A2($Html.div,
   ...
   var viewBuildOutput = F2(function (actions,output) {
      var _p8 = output;
      if (_p8.ctor === "Just") {
            return A2($BuildOutput.view,A2($Signal.forwardTo,actions,BuildOutputAction),_p8._0);
         } else {
   ...
   var view = F2(function (actions,model) {
      var _p9 = model.build;
      if (_p9.ctor === "Just") {
            return A2($Html.div,_U.list([]),_U.list([A3(viewBuildHeader,actions,_p9._0,model),A2($Html$Lazy.lazy,viewBuildOutput(actions),model.output)]));
         } else {
            return $LoadingIndicator.view;
         }
   });
   ...
   var handleHistoryFetched = F2(function (history,model) {
      ...
      function (_p10) {
         return A2(F2(function (x,y) {    return _U.eq(x,y);}),model.buildId,function (_) {    return _.id;}(_p10));
      },
      history.content);
      ...
      var _p11 = {ctor: "_Tuple2",_0: history.pagination.nextPage,_1: A2($Maybe.andThen,model.build,function (_) {    return _.job;})};
      if (_p11._0.ctor === "Nothing") {
            ...
            if (_p11._1.ctor === "Just") {
                  return {ctor: "_Tuple2"
                         ,_0: withBuilds
                         ,_1: $Effects.batch(_U.list([A2(fetchBuildHistory,_p11._1._0,$Maybe.Just(_p11._0._0)),scrollToCurrent]))};
               } else {
                  return _U.crashCase("Build",{start: {line: 196,column: 5},end: {line: 204,column: 33}},_p11)("impossible");
               }
         }
   });
   ...
   var handleBuildFetched = F2(function (build,model) {
      ...
      var _p14 = _U.eq(build.status,$Concourse$BuildStatus.Pending) ? pollUntilStarted(withBuild) : A2(initBuildOutput,build,withBuild);
      ...
      {case "Noop": return {ctor: "_Tuple2",_0: model,_1: $Effects.none};
         ...
         case "BuildAborted": if (_p15._0.ctor === "Ok") {
                 ...
                 if (_p15._0._0.ctor === "BadResponse" && _p15._0._0._0 === 401) {
                       ...
                       return A2($Debug.log,
                       A2($Basics._op["++"],"failed to abort build: ",$Basics.toString(_p15._0._0)),
                       {ctor: "_Tuple2",_0: model,_1: $Effects.none});
                    }
              }
         case "BuildFetched": if (_p15._0.ctor === "Ok") {
                 ...
                 return A2($Debug.log,
                 A2($Basics._op["++"],"failed to fetch build: ",$Basics.toString(_p15._0._0)),
                 {ctor: "_Tuple2",_0: model,_1: $Effects.none});
              }
         ...
         case "BuildStatus": var _p19 = _p15._0;
           return {ctor: "_Tuple2"
                  ,_0: A3(updateStartFinishAt,_p19,_p15._1,$Concourse$BuildStatus.isRunning(model.status) ? _U.update(model,{status: _p19}) : model)
                  ,_1: $Effects.none};
         case "BuildHistoryFetched": if (_p15._0.ctor === "Err") {
                 return A2($Debug.log,
                 A2($Basics._op["++"],"failed to fetch build history: ",$Basics.toString(_p15._0._0)),
                 {ctor: "_Tuple2",_0: model,_1: $Effects.none});
              } else {
         ...
         case "ScrollBuilds": if (_p15._0._0 === 0) {
                 return {ctor: "_Tuple2",_0: model,_1: scrollBuilds(_p15._0._1)};
              } else {
                 return {ctor: "_Tuple2",_0: model,_1: scrollBuilds(0 - _p15._0._0)};
              }
         default: return {ctor: "_Tuple2",_0: _U.update(model,{now: _p15._0}),_1: $Effects.none};}
   });
   var LoginRequired = {ctor: "LoginRequired"};
   var StepsComplete = {ctor: "StepsComplete"};
   var StepsLiveUpdating = {ctor: "StepsLiveUpdating"};
...
Elm.Main.make = function (_elm) {
   ...
   var app = function () {
      ...
      return $StartApp.start({init: A3($Build.init,redirects.address,pageDrivenActions.address,buildId)
                             ,update: $Build.update
                             ,view: $Build.view
