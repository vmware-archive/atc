...
Elm.Ansi.Log.make = function (_elm) {
   ...
   $String = Elm.String.make(_elm);
   var _op = {};
   var lineLen = function (line) {    var _p0 = line;if (_p0.ctor === "[]") {    return 0;} else {    return $String.length(_p0._0.text) + lineLen(_p0._1);}};
   var takeLen = F2(function (len,line) {
      if (_U.eq(len,0)) return _U.list([]); else {
            var _p1 = line;
            if (_p1.ctor === "::") {
                  var _p2 = _p1._0;
                  var chunkLen = $String.length(_p2.text);
                  return _U.cmp(chunkLen,len) < 0 ? A2($List._op["::"],_p2,A2(takeLen,len - chunkLen,_p1._1)) : _U.list([_U.update(_p2,
                  {text: A2($String.left,len,_p2.text)})]);
               } else {
                  return _U.list([]);
               }
         }
   ...
   var dropLen = F2(function (len,line) {
      dropLen: while (true) {
         ...
         if (_p3.ctor === "::") {
               var _p5 = _p3._1;
               var _p4 = _p3._0;
               var chunkLen = $String.length(_p4.text);
               if (_U.cmp(chunkLen,len) > 0) return A2($List._op["::"],_U.update(_p4,{text: A2($String.dropLeft,len,_p4.text)}),_p5); else {
                     var _v3 = len - chunkLen,_v4 = _p5;
                     len = _v3;
                     line = _v4;
                     continue dropLen;
                  }
   ...
   var updateStyle = F2(function (action,style) {
      var _p6 = action;
      switch (_p6.ctor)
      {case "SetForeground": return _U.update(style,{foreground: _p6._0});
         case "SetBackground": return _U.update(style,{background: _p6._0});
         case "SetInverted": return _U.update(style,{inverted: _p6._0});
         case "SetBold": return _U.update(style,{bold: _p6._0});
         case "SetFaint": return _U.update(style,{faint: _p6._0});
         case "SetItalic": return _U.update(style,{italic: _p6._0});
         case "SetUnderline": return _U.update(style,{underline: _p6._0});
   ...
   var appendLine = F3(function (after,line,lines) {
      appendLine: while (true) if (_U.eq(after,0)) return A2($Array.push,line,lines); else {
            var _v6 = after - 1,_v7 = line,_v8 = A2($Array.push,_U.list([]),lines);
            after = _v6;
            line = _v7;
            lines = _v8;
            continue appendLine;
   ...
   var handleAction = F2(function (action,model) {
      handleAction: while (true) {
         var _p7 = action;
         switch (_p7.ctor)
         {case "Print": var _p8 = _p7._0;
              var chunk = A2(Chunk,_p8,model.style);
              var update = A2(writeChunk,model.position.column,chunk);
              return _U.update(model,
              {lines: A3(updateLine,model.position.row,update,model.lines),position: A3(moveCursor,0,$String.length(_p8),model.position)});
            case "CarriageReturn": return _U.update(model,{position: A2(CursorPosition,model.position.row,0)});
            case "Linebreak": var _v11 = $Ansi.Print(""),
              _v12 = function () {
                 var _p9 = model.lineDiscipline;
                 if (_p9.ctor === "Raw") {
            ...
            case "CursorUp": return _U.update(model,{position: A3(moveCursor,0 - _p7._0,0,model.position)});
            case "CursorDown": return _U.update(model,{position: A3(moveCursor,_p7._0,0,model.position)});
            case "CursorForward": return _U.update(model,{position: A3(moveCursor,0,_p7._0,model.position)});
            case "CursorBack": return _U.update(model,{position: A3(moveCursor,0,0 - _p7._0,model.position)});
            case "CursorPosition": return _U.update(model,{position: A2(CursorPosition,_p7._0 - 1,_p7._1 - 1)});
            case "CursorColumn": return _U.update(model,{position: A2(CursorPosition,model.position.row,_p7._0)});
   ...
   var Window = F6(function (a,b,c,d,e,f) {    return {lineDiscipline: a,lines: b,position: c,savedPosition: d,style: e,remainder: f};});
   ...
   var decodeEvent = function (e) {
      ...
      {case "status": return A2($Json$Decode.decodeValue,A2($Json$Decode.object1,BuildStatus,decodeStatus),e.value);
         ...
         case "error": return A2($Json$Decode.decodeValue,
           A3($Json$Decode.object2,Error,A2($Json$Decode._op[":="],"origin",decodeOrigin),A2($Json$Decode._op[":="],"message",$Json$Decode.string)),
           e.value);
         ...
         case "finish-get": return A2($Json$Decode.decodeValue,
           A3($Json$Decode.object2,FinishGet,A2($Json$Decode._op[":="],"origin",decodeOrigin),A2($Json$Decode._op[":="],"exit_status",$Json$Decode.$int)),
           e.value);
...
Elm.StepTree.make = function (_elm) {
   ...
   var viewStepLog = function (window) {    return A2($Html.pre,_U.list([]),$Array.toList(A2($Array.map,lazyLine,window.lines)));};
   ...
   var getAggIndex = F2(function (idx,tree) {
      var _p2 = tree;
      if (_p2.ctor === "Aggregate") {
            var _p3 = A2($Array.get,idx,_p2._0);
            if (_p3.ctor === "Just") {
                  return _p3._0;
               } else {
                  return _U.crashCase("StepTree",{start: {line: 277,column: 7},end: {line: 282,column: 35}},_p3)("impossible");
               }
         } else {
            return _U.crashCase("StepTree",{start: {line: 275,column: 3},end: {line: 285,column: 31}},_p2)("impossible");
         }
   });
   var getHook = function (tree) {
      var _p6 = tree;
      switch (_p6.ctor)
      {case "OnSuccess": return _p6._0.hook;
         case "OnFailure": return _p6._0.hook;
         case "Ensure": return _p6._0.hook;
         default: return _U.crashCase("StepTree",{start: {line: 245,column: 3},end: {line: 256,column: 31}},_p6)("impossible");}
   };
   var getStep = function (tree) {
      var _p8 = tree;
      switch (_p8.ctor)
      {case "OnSuccess": return _p8._0.step;
         case "OnFailure": return _p8._0.step;
         case "Ensure": return _p8._0.step;
         case "Try": return _p8._0;
         case "Timeout": return _p8._0;
         default: return _U.crashCase("StepTree",{start: {line: 199,column: 3},end: {line: 216,column: 31}},_p8)("impossible");}
   };
   var updateAt = F3(function (id,update,root) {
      var _p10 = A2($Dict.get,id,root.foci);
      if (_p10.ctor === "Nothing") {
            return root;
         } else {
            return _U.update(root,{tree: A3($Focus.update,_p10._0,update,root.tree)});
         }
   });
   ...
   var initBottom = F3(function (create,id,name) {
      var step = {id: id,name: name,state: StepStatePending,log: $Ansi$Log.init($Ansi$Log.Cooked),error: $Maybe.Nothing,expanded: true};
      return {tree: create(step),foci: A2($Dict.singleton,id,A2($Focus.create,$Basics.identity,$Basics.identity))};
   });
   var Step = F6(function (a,b,c,d,e,f) {    return {id: a,name: b,state: c,log: d,error: e,expanded: f};});
   ...
   var viewStep = F3(function (actions,_p11,icon) {
      ...
      _U.list([A2($Html.div,
              ...
              _U.list([viewStepState(_p12.state),typeIcon(icon),A2($Html.h3,_U.list([]),_U.list([$Html.text(_p12.name)]))]))
              ,A2($Html.div,
              _U.list([$Html$Attributes.classList(_U.list([{ctor: "_Tuple2",_0: "step-body",_1: true}
                                                          ,{ctor: "_Tuple2",_0: "step-collapsed",_1: $Basics.not(_p12.expanded)}]))]),
   ...
   var view = F2(function (actions,tree) {
      view: while (true) {
         var _p14 = tree;
         switch (_p14.ctor)
         {case "Task": return A3(viewStep,actions,_p14._0,"fa-terminal");
            case "Get": return A3(viewStep,actions,_p14._0,"fa-arrow-down");
            case "DependentGet": return A3(viewStep,actions,_p14._0,"fa-arrow-down");
            case "Put": return A3(viewStep,actions,_p14._0,"fa-arrow-up");
            case "Try": var _v10 = actions,_v11 = _p14._0;
              actions = _v10;
              tree = _v11;
              continue view;
            case "Timeout": var _v12 = actions,_v13 = _p14._0;
              actions = _v12;
              tree = _v13;
              continue view;
            case "Aggregate": return A2($Html.div,_U.list([$Html$Attributes.$class("aggregate")]),$Array.toList(A2($Array.map,viewSeq(actions),_p14._0)));
            case "OnSuccess": return A4(viewHooked,"success",actions,_p14._0.step,_p14._0.hook);
            case "OnFailure": return A4(viewHooked,"failure",actions,_p14._0.step,_p14._0.hook);
            default: return A4(viewHooked,"ensure",actions,_p14._0.step,_p14._0.hook);}
      }
   });
   ...
   var wrapAgg = function (i) {
      return $Dict.map(F2(function (_p27,focus) {    return A2($Focus._op["=>"],A2($Focus.create,getAggIndex(i),setAggIndex(i)),focus);}));
   };
   var DependentGet = function (a) {    return {ctor: "DependentGet",_0: a};};
   var Put = function (a) {    return {ctor: "Put",_0: a};};
   var Get = F2(function (a,b) {    return {ctor: "Get",_0: a,_1: b};});
   ...
   var init = function (plan) {
      var _p28 = plan.step;
      switch (_p28.ctor)
      {case "Task": return A3(initBottom,Task,plan.id,_p28._0);
         case "Get": return A3(initBottom,A2($Basics.flip,Get,_p28._1),plan.id,_p28._0);
         case "Put": return A3(initBottom,Put,plan.id,_p28._0);
         case "DependentGet": return A3(initBottom,DependentGet,plan.id,_p28._0);
         case "Aggregate": var inited = A2($Array.map,init,_p28._0);
         ...
         case "OnSuccess": return A2(initHookedStep,OnSuccess,_p28._0);
         case "OnFailure": return A2(initHookedStep,OnFailure,_p28._0);
         case "Ensure": return A2(initHookedStep,Ensure,_p28._0);
         case "Try": return A2(initWrappedStep,Try,_p28._0);
         default: return A2(initWrappedStep,Timeout,_p28._0);}
   };
   ...
   var map = F2(function (f,tree) {
      var _p30 = tree;
      switch (_p30.ctor)
      {case "Task": return Task(f(_p30._0));
         case "Get": return A2(Get,f(_p30._0),_p30._1);
         case "Put": return Put(f(_p30._0));
         case "DependentGet": return DependentGet(f(_p30._0));
         default: return tree;}
   });
   var update = F2(function (action,root) {
      var _p31 = action;
      return A3(updateAt,_p31._0,map(function (step) {    return _U.update(step,{expanded: $Basics.not(step.expanded)});}),root);
   });
...
<<<<<<< HEAD
         default: return _U.crashCase("Build",{start: {line: 473,column: 3},end: {line: 480,column: 48}},_p0)(A2($Basics._op["++"],"unknown state: ",str));}
   };
   var parseEvent = function (e) {    return A2($Json$Decode.decodeString,$BuildEvent.decode,e.data);};
=======
         default: return _U.crashCase("Build",
           {start: {line: 517,column: 3},end: {line: 523,column: 48}},
...
>>>>>>> wip
   ...
   var setStepError = F2(function (message,tree) {
      return A2($StepTree.map,function (step) {    return _U.update(step,{error: $Maybe.Just(message)});},tree);
   });
...
=======
   ...
   var BuildHistory = F2(function (a,b) {
      return {builds: a,nextPage: b};
   });
>>>>>>> wip
   ...
   var viewBuildHeader = F4(function (actions,build,status,history) {
      var buildTitle = function () {
         ...
         if (_p7.ctor === "Just") {
               ...
               "/pipelines/",
<<<<<<< HEAD
               A2($Basics._op["++"],_p5._0.pipelineName,A2($Basics._op["++"],"/jobs/",_p6))))]),
               _U.list([$Html.text(A2($Basics._op["++"],_p6,A2($Basics._op["++"]," #",build.name)))]));
=======
               A2($Basics._op["++"],
               _p7._0.pipelineName,
               A2($Basics._op["++"],"/jobs/",_p8))))]),
...
>>>>>>> wip
      ...
      var triggerButton = function () {
         ...
         if (_p9.ctor === "Just") {
               ...
               "/pipelines/",
<<<<<<< HEAD
               A2($Basics._op["++"],_p7._0.pipelineName,A2($Basics._op["++"],"/jobs/",A2($Basics._op["++"],_p7._0.name,"/builds"))));
=======
               A2($Basics._op["++"],
               _p9._0.pipelineName,
               A2($Basics._op["++"],
               "/jobs/",
               A2($Basics._op["++"],_p9._0.name,"/builds"))));
>>>>>>> wip
               return A2($Html.form,
      ...
      _U.list([A2($Html.div,
              ...
              ,A2($Html.ul,_U.list([$Html$Attributes.id("builds")]),A2($List.map,renderHistory(build),history))]));
   });
   var StepTreeAction = function (a) {    return {ctor: "StepTreeAction",_0: a};};
   var view = F2(function (actions,model) {
<<<<<<< HEAD
      var _p8 = {ctor: "_Tuple2",_0: model.build,_1: model.stepRoot};
      if (_p8.ctor === "_Tuple2" && _p8._0.ctor === "Just") {
            if (_p8._1.ctor === "Just") {
                  var _p9 = _p8._0._0;
                  return A2($Html.div,
                  _U.list([]),
                  _U.list([A4(viewBuildHeader,actions,_p9,model.status,A2($Maybe.withDefault,_U.list([]),model.history))
                          ,A2($Html.div,
                          A2($List._op["::"],$Html$Attributes.id("build-body"),paddingClass(_p9)),
                          _U.list([model.buildRunning || model.eventsLoaded ? A2($Html.div,
                          _U.list([$Html$Attributes.$class("steps")]),
                          _U.list([A2($StepTree.view,A2($Signal.forwardTo,actions,StepTreeAction),_p8._1._0.tree)])) : $Html.text("loading...")]))]));
=======
      ...
      if (_p10.ctor === "_Tuple2" && _p10._0.ctor === "Just") {
            if (_p10._1.ctor === "Just") {
                  ...
                  _U.list([A4(viewBuildHeader,
                          ...
                          _p10._1._0.tree)])) : $Html.text("loading...")]))]));
>>>>>>> wip
               } else {
                  var _p12 = _p10._0._0;
                  return A2($Html.div,
                  _U.list([]),
<<<<<<< HEAD
                  _U.list([A4(viewBuildHeader,actions,_p10,model.status,A2($Maybe.withDefault,_U.list([]),model.history))
                          ,A2($Html.div,A2($List._op["::"],$Html$Attributes.id("build-body"),paddingClass(_p10)),_U.list([]))]));
=======
                  _U.list([A4(viewBuildHeader,
                          actions,
                          _p12,
...
<<<<<<< HEAD
      ...
      var eventsSub = A2($EventSource.on,"event",A2($Signal.forwardTo,actions,function (_p11) {    return Event(parseEvent(_p11));}));
=======
      var endSub = A2($EventSource.on,
      "end",
      A2($Signal.forwardTo,actions,$Basics.always(EndOfEvents)));
      var eventsSub = A2($EventSource.on,
      "event",
      A2($Signal.forwardTo,
      actions,
      function (_p13) {
         return Event(parseEvent(_p13));
      }));
>>>>>>> wip
   ...
   var PlanFetched = function (a) {    return {ctor: "PlanFetched",_0: a};};
...
<<<<<<< HEAD
      ...
      return $Effects.task(A2($Task.andThen,$Task.sleep(delay),function (_p12) {    return fetchPlan;}));
=======
...
>>>>>>> wip
   ...
   var parseBuildHistory = function (result) {
      ...
      if (_p15.ctor === "Ok") {
            ...
            var history = A2($Result.andThen,
            handleResponse(_p15._0),
            function (_p16) {
               return A2($Result.formatError,
               $Http.UnexpectedPayload,
               decode(_p16));
            });
            return BuildHistoryFetched(A2($Result.map,
            function (builds) {
               return {builds: builds,nextPage: $Maybe.Nothing};
            },
            history));
         } else {
...
<<<<<<< HEAD
   ...
   var update = F2(function (action,model) {
      ...
      {case "Noop": return {ctor: "_Tuple2",_0: model,_1: $Effects.none};
         case "ScrollTick": return $Basics.not(model.eventsLoaded) && model.autoScroll ? {ctor: "_Tuple2"
                                                                                         ...
                                                                                         ,_1: $Effects.batch(_U.list([keepScrolling
                                                                                                                     ,scrollToBottom]))} : {ctor: "_Tuple2"
                                                                                                                                           ,_0: model
                                                                                                                                           ,_1: $Effects.none};
         case "ScrollFromBottom": return _U.eq(_p13._0,0) ? {ctor: "_Tuple2"
         ...
         case "PlanFetched": if (_p13._0.ctor === "Err") {
                 if (_p13._0._0.ctor === "BadResponse" && _p13._0._0._0 === 404) {
                       return {ctor: "_Tuple2",_0: model,_1: A2(fetchBuildPlan,$Time.second,model.buildId)};
                    } else {
                       return A2($Debug.log,
                       A2($Basics._op["++"],"failed to fetch plan: ",$Basics.toString(_p13._0._0)),
=======
      A2($Basics._op["++"],
      job.pipelineName,
      A2($Basics._op["++"],
   ...
   var update = F2(function (action,model) {
      ...
      {case "Noop": return {ctor: "_Tuple2"
         ...
         return $Basics.not(model.eventsLoaded) && model.autoScroll ? {ctor: "_Tuple2"
                                                                      ...
                                                                      ,_1: $Effects.batch(_U.list([keepScrolling
                                                                                                  ,scrollToBottom]))} : {ctor: "_Tuple2"
                                                                                                                        ,_0: model
                                                                                                                        ,_1: $Effects.none};
         case "ScrollFromBottom": return _U.eq(_p17._0,
           0) ? {ctor: "_Tuple2"
                ,_0: _U.update(model,{autoScroll: true})
                ,_1: $Effects.tick($Basics.always(ScrollTick))} : {ctor: "_Tuple2"
                                                                  ,_0: _U.update(model,{autoScroll: false})
         ...
         case "PlanFetched": if (_p17._0.ctor === "Err") {
                 if (_p17._0._0.ctor === "BadResponse" && _p17._0._0._0 === 404)
                 {
                       return {ctor: "_Tuple2"
                              ,_0: model
...
>>>>>>> wip
                 ...
                 return {ctor: "_Tuple2"
<<<<<<< HEAD
                        ,_0: _U.update(model,{stepRoot: $Maybe.Just($StepTree.init(_p13._0._0))})
=======
                        ,_0: _U.update(model,
                        {stepRoot: $Maybe.Just($StepTree.init(_p17._0._0))})
>>>>>>> wip
                        ,_1: A2(subscribeToEvents,model.buildId,model.actions)};
              }
         case "BuildFetched": if (_p17._0.ctor === "Err") {
                 return A2($Debug.log,
<<<<<<< HEAD
                 A2($Basics._op["++"],"failed to fetch build: ",$Basics.toString(_p13._0._0)),
=======
                 A2($Basics._op["++"],
...
>>>>>>> wip
                 ...
                 var _p20 = _p17._0._0;
                 var status = toStatus(_p20.status);
                 ...
                 return {ctor: "_Tuple2"
<<<<<<< HEAD
                        ,_0: _U.update(model,{build: $Maybe.Just(_p16),status: status,buildRunning: running})
=======
                        ,_0: _U.update(model,
                        {build: $Maybe.Just(_p20),status: status,buildRunning: running})
>>>>>>> wip
                        ,_1: function () {
                           var _p19 = _p20.job;
                           if (_p19.ctor === "Just") {
                                 return fetchBuildHistory(_p19._0);
                              } else {
                                 return $Effects.none;
                              }
                        }()};
         ...
         case "BuildHistoryFetched": if (_p17._0.ctor === "Err") {
                 return A2($Debug.log,
<<<<<<< HEAD
                 A2($Basics._op["++"],"failed to fetch build history: ",$Basics.toString(_p13._0._0)),
                 {ctor: "_Tuple2",_0: model,_1: $Effects.none});
              } else {
                 return {ctor: "_Tuple2",_0: _U.update(model,{history: $Maybe.Just(_p13._0._0)}),_1: $Effects.none};
              }
         case "Listening": return {ctor: "_Tuple2",_0: _U.update(model,{eventSource: $Maybe.Just(_p13._0)}),_1: $Effects.none};
         case "Opened": return {ctor: "_Tuple2",_0: model,_1: scrollToBottom};
         case "Errored": return {ctor: "_Tuple2",_0: model,_1: $Effects.none};
         case "Event": if (_p13._0.ctor === "Ok") {
                 switch (_p13._0._0.ctor)
                 {case "Log": return {ctor: "_Tuple2"
                                     ,_0: A3(updateStep,_p13._0._0._0.id,function (_p17) {    return setRunning(A2(appendStepLog,_p13._0._0._1,_p17));},model)
=======
                 A2($Basics._op["++"],
                 ...
                 return {ctor: "_Tuple2"
                        ,_0: _U.update(model,{history: $Maybe.Just(_p17._0._0.builds)})
                        ,_1: $Effects.none};
              }
         case "Listening": return {ctor: "_Tuple2"
                                  ,_0: _U.update(model,{eventSource: $Maybe.Just(_p17._0)})
                                  ,_1: $Effects.none};
         ...
         case "Errored": return {ctor: "_Tuple2"
                                ,_0: model
                                ,_1: $Effects.none};
         case "Event": if (_p17._0.ctor === "Ok") {
                 switch (_p17._0._0.ctor)
                 {case "Log": return {ctor: "_Tuple2"
                                     ,_0: A3(updateStep,
                                     _p17._0._0._0.id,
                                     function (_p21) {
                                        return setRunning(A2(appendStepLog,_p17._0._0._1,_p21));
                                     },
                                     model)
>>>>>>> wip
                                     ,_1: $Effects.none};
                    case "Error": return {ctor: "_Tuple2"
                                         ...
                                         _p17._0._0._0.id,
                                         function (_p22) {
                                            return setRunning(A2(setStepError,_p17._0._0._1,_p22));
                                         },
                                         model)
                                         ,_1: $Effects.none};
<<<<<<< HEAD
                    case "InitializeTask": return {ctor: "_Tuple2",_0: A3(updateStep,_p13._0._0._0.id,setRunning,model),_1: $Effects.none};
                    case "StartTask": return {ctor: "_Tuple2",_0: A3(updateStep,_p13._0._0._0.id,setRunning,model),_1: $Effects.none};
                    case "FinishTask": return {ctor: "_Tuple2",_0: A3(updateStep,_p13._0._0._0.id,finishStep(_p13._0._0._1),model),_1: $Effects.none};
                    case "FinishGet": return {ctor: "_Tuple2",_0: A3(updateStep,_p13._0._0._0.id,finishStep(_p13._0._0._1),model),_1: $Effects.none};
                    case "FinishPut": return {ctor: "_Tuple2",_0: A3(updateStep,_p13._0._0._0.id,finishStep(_p13._0._0._1),model),_1: $Effects.none};
                    default: return {ctor: "_Tuple2",_0: model.buildRunning ? _U.update(model,{status: _p13._0._0._0}) : model,_1: $Effects.none};}
              } else {
                 return {ctor: "_Tuple2",_0: model,_1: A2($Debug.log,_p13._0._0,$Effects.none)};
              }
         case "StepTreeAction": return {ctor: "_Tuple2"
                                       ,_0: _U.update(model,{stepRoot: A2($Maybe.map,$StepTree.update(_p13._0),model.stepRoot)})
                                       ,_1: $Effects.none};
         case "EndOfEvents": var _p19 = model.eventSource;
           if (_p19.ctor === "Just") {
                 return {ctor: "_Tuple2",_0: _U.update(model,{eventsLoaded: true}),_1: closeEvents(_p19._0)};
=======
                    case "InitializeTask": return {ctor: "_Tuple2"
                                                  ,_0: A3(updateStep,_p17._0._0._0.id,setRunning,model)
                                                  ,_1: $Effects.none};
                    ...
                    default: return {ctor: "_Tuple2"
                                    ,_0: model.buildRunning ? _U.update(model,
                                    {status: _p17._0._0._0}) : model
                                    ,_1: $Effects.none};}
              } else {
                 return {ctor: "_Tuple2"
                        ,_0: model
                        ,_1: A2($Debug.log,_p17._0._0,$Effects.none)};
              }
         case "StepTreeAction": return {ctor: "_Tuple2"
                                       ,_0: _U.update(model,
                                       {stepRoot: A2($Maybe.map,
                                       $StepTree.update(_p17._0),
                                       model.stepRoot)})
                                       ,_1: $Effects.none};
