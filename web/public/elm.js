...
Elm.Ansi.Log.make = function (_elm) {
      ...
      takeLen: while (true) if (_U.eq(len,0)) return acc; else {
            ...
            if (_p2.ctor === "::") {
                  ...
                  if (_U.cmp(chunkLen,len) < 0) {
                        var _v5 = A2($Basics._op["++"],acc,_U.list([_p3])),
                        _v6 = len - chunkLen,
                        _v7 = _p2._1;
                        acc = _v5;
                        len = _v6;
                        line = _v7;
                        continue takeLen;
                     } else return A2($Basics._op["++"],
                     acc,
                     _U.list([_U.update(_p3,
   ...
   var dropLen = F2(function (len,line) {
      dropLen: while (true) {
         ...
         if (_p4.ctor === "::") {
               ...
               if (_U.cmp(chunkLen,len) > 0) return A2($List._op["::"],
                  _U.update(_p5,{text: A2($String.dropLeft,len,_p5.text)}),
                  _p6); else {
   ...
   var writeChunk = F3(function (pos,chunk,line) {
      var after = A2(dropLen,
      pos + $String.length(chunk.text),
      line);
      ...
      chunksBefore,
      _U.list([{style: chunk.style
               ,text: A2($String.repeat,
               pos - chunksLen,
               " ")}])) : chunksBefore;
      return A2($Basics._op["++"],
      before,
      A2($Basics._op["++"],_U.list([chunk]),after));
   });
   ...
   var appendLine = F3(function (after,line,lines) {
      ...
      return A2($Array.push,line,lines); else {
            var _v12 = after - 1,
            _v13 = line,
            _v14 = A2($Array.push,_U.list([]),lines);
            after = _v12;
            line = _v13;
            lines = _v14;
            continue appendLine;
      ...
      handleAction: while (true) {
         ...
         {case "Print": var _p9 = _p8._0;
            ...
            case "CursorUp": return _U.update(model,
              {position: A3(moveCursor,0 - _p8._0,0,model.position)});
            case "CursorDown": return _U.update(model,
              {position: A3(moveCursor,_p8._0,0,model.position)});
            case "CursorForward": return _U.update(model,
              {position: A3(moveCursor,0,_p8._0,model.position)});
            case "CursorBack": return _U.update(model,
              {position: A3(moveCursor,0,0 - _p8._0,model.position)});
            case "CursorPosition": return _U.update(model,
              {position: A2(CursorPosition,_p8._0 - 1,_p8._1 - 1)});
            case "CursorColumn": return _U.update(model,
              {position: A2(CursorPosition,model.position.row,_p8._0)});
            ...
            case "EraseLine": var _p11 = _p8._0;
              ...
              {case "EraseToBeginning": var chunk = A2(Chunk,
                   ...
                   return _U.update(model,
                   {lines: A3(updateLine,model.position.row,update,model.lines)});
                 case "EraseToEnd": var update = A2(takeLen,
                   _U.list([]),
...
Elm.StepTree.make = function (_elm) {
   ...
   var viewPair = F2(function (name,value) {
      return _U.list([A2($Html.dt,
                     ...
                     ,A2($Html.dd,_U.list([]),_U.list([$Html.text(value)]))]);
   });
   ...
   var updateAt = F3(function (id,update,root) {
      ...
      if (_p9.ctor === "Nothing") {
            ...
            {tree: A3($Focus.update,_p9._0,update,root.tree)});
         }
   });
   var isFirstOccurrence = F2(function (resources,step) {
      isFirstOccurrence: while (true) {
         ...
         if (_p11.ctor === "[]") {
               ...
               if (_U.eq(_p11._0.name,step)) return _p11._0.firstOccurrence;
               else {
   ...
   var stepIsActive = function (_p12) {
      return isActive(function (_) {    return _.state;}(_p12));
   };
   ...
   var toggleExpanded = function (_p14) {
      var _p15 = _p14;
      return $Maybe.Just($Basics.not(A2($Maybe.withDefault,
      autoExpanded(_p15.state),
      _p15.expanded)));
   };
   ...
   var viewStep = F4(function (actions,model,_p16,icon) {
      ...
      _U.list([$Html$Attributes.classList(_U.list([{ctor: "_Tuple2"
                                                  ...
                                                  ,{ctor: "_Tuple2"
                                                   ,_0: "inactive"
                                                   ,_1: $Basics.not(isActive(_p22))}
                                                  ,{ctor: "_Tuple2"
                                                   ,_0: "first-occurrence"
                                                   ,_1: _p17.firstOccurrence}]))]),
      _U.list([A2($Html.div,
              _U.list([$Html$Attributes.$class("header")
                      ,A2($Html$Events.onClick,actions,ToggleStep(_p17.id))]),
              ...
              A2($Maybe.map,
              $Basics.always(true),
              _p21)) ? _U.list([$DictView.view($Dict.fromList(A2($List.map,
                               function (_p18) {
                                  var _p19 = _p18;
                                  return {ctor: "_Tuple2",_0: _p19.name,_1: _p19.value};
                               },
                               _p17.metadata)))
         ...
         {case "Task": return A4(viewStep,
            ...
            case "Retry": var _p27 = _p23._2;
              ...
              _U.list([A2($Html.ul,
                      ...
                      A3(viewTab,actions,_p23._0,_p27),
                      _p26)))
                      ,function () {
   ...
   var wrapMultiStep = function (i) {
      return $Dict.map(F2(function (_p44,focus) {
         return A2($Focus._op["=>"],
   ...
   var init = F2(function (resources,plan) {
      ...
      {case "Task": return A3(initBottom,Task,plan.id,_p45._0);
         case "Get": var _p47 = _p45._0;
           ...
           function (_p46) {
              return Get(A4(setupGetStep,resources,_p47,_p45._1,_p46));
           },
           plan.id,
           _p47);
...
Elm.Job.make = function (_elm) {
   ...
   var viewBuildOutputs = F2(function (model,bo) {
      ...
      _U.list([A2($Html.td,
              ...
              _U.list([$DictView.view(bo.version)]))]));
   });
   var viewBuildInputs = F2(function (model,bi) {
      ...
      _U.list([A2($Html.td,
              ...
              ,A2($Html.td,
              _U.list([$Html$Attributes.$class("resource-version")]),
              _U.list([$DictView.view(bi.version)]))]));
   });
      ...
      _U.list([function () {
                 ...
                 if (_p1.ctor === "Nothing") {
                       ...
                       _U.list([$Html$Attributes.$class("arrow")
                               ...
                               A2($Basics._op["++"],
                               model.jobInfo.name,
                               A2($Basics._op["++"],"?",paginationParam(_p1._0)))))))]),
                       _U.list([A2($Html.i,
                       _U.list([$Html$Attributes.$class("fa fa-arrow-left")]),
                       _U.list([]))]))]));
                    }
              ...
              ,function () {
                 ...
                 if (_p2.ctor === "Nothing") {
                       ...
                       _U.list([$Html$Attributes.$class("arrow")
                               ...
                               A2($Basics._op["++"],
                               model.jobInfo.name,
                               A2($Basics._op["++"],"?",paginationParam(_p2._0)))))))]),
                       _U.list([A2($Html.i,
                       _U.list([$Html$Attributes.$class("fa fa-arrow-right")]),
                       _U.list([]))]))]));
                    }
   ...
   buildWithResources) {
      var outputsTable = function () {
         ...
         if (_p4.ctor === "Nothing") {
               ...
               A2($List.map,viewBuildOutputs(model),_p4._0.resources.outputs));
            }
      }();
      var inputsTable = function () {
         ...
         if (_p5.ctor === "Nothing") {
               ...
               return A2($Html.table,
               _U.list([$Html$Attributes.$class("build-resources")]),
               A2($List.map,viewBuildInputs(model),_p5._0.resources.inputs));
            }
      }();
