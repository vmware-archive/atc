...
Elm.Build.make = function (_elm) {
   ...
   var viewBuildHeader = F3(function (actions,build,_p7) {
      ...
      var triggerButton = function () {
         ...
         if (_p11.ctor === "Just") {
               ...
               _U.list([$Html$Attributes.$class("build-action fr"),$Html$Attributes.disabled(buttonDisabled)]),
      ...
      return A2($Html.div,
      _U.list([$Html$Attributes.id("page-header"),$Html$Attributes.$class($Concourse$BuildStatus.show(_p13))]),
      _U.list([A2($Html.div,
   ...
   var viewBuildOutput = F2(function (actions,output) {
      var _p15 = output;
      if (_p15.ctor === "Just") {
            return A2($BuildOutput.view,A2($Signal.forwardTo,actions,BuildOutputAction),_p15._0);
         } else {
            return A2($Html.div,_U.list([]),_U.list([]));
         }
   });
   ...
   var fetchBuildJobDetails = function (build) {
      ...
      if (_p18.ctor === "Nothing") {
            ...
            return $Effects.task(A2($Task.map,BuildJobDetailsFetched,$Task.toResult($Concourse$Job.fetchJob(_p18._0))));
         }
   };
   ...
   var handleHistoryFetched = F2(function (history,model) {
      ...
      function (_p19) {
         return A2(F2(function (x,y) {    return _U.eq(x,y);}),model.buildId,function (_) {    return _.id;}(_p19));
      },
      history.content);
      ...
      var _p20 = {ctor: "_Tuple2",_0: history.pagination.nextPage,_1: A2($Maybe.andThen,model.build,function (_) {    return _.job;})};
      if (_p20._0.ctor === "Nothing") {
            ...
            if (_p20._1.ctor === "Just") {
                  return {ctor: "_Tuple2"
                         ,_0: withBuilds
                         ,_1: $Effects.batch(_U.list([A2(fetchBuildHistory,_p20._1._0,$Maybe.Just(_p20._0._0)),scrollToCurrent]))};
               } else {
                  return _U.crashCase("Build",{start: {line: 247,column: 5},end: {line: 255,column: 33}},_p20)("impossible");
               }
         }
   });
   ...
   var update = F2(function (action,model) {
      ...
      {case "Noop": return {ctor: "_Tuple2",_0: model,_1: $Effects.none};
         ...
         case "BuildPrepFetched": if (_p27._0.ctor === "Ok") {
                 ...
                 return A2($Debug.log,
                 A2($Basics._op["++"],"failed to fetch build preparation: ",$Basics.toString(_p27._0._0)),
                 {ctor: "_Tuple2",_0: model,_1: $Effects.none});
              }
         ...
         case "BuildStatus": var _p31 = _p27._0;
           return {ctor: "_Tuple2"
                  ,_0: A3(updateStartFinishAt,_p31,_p27._1,$Concourse$BuildStatus.isRunning(model.status) ? _U.update(model,{status: _p31}) : model)
                  ,_1: $Effects.none};
         ...
         case "BuildJobDetailsFetched": if (_p27._0.ctor === "Ok") {
                 ...
                 return A2($Debug.log,
                 A2($Basics._op["++"],"failed to fetch build job details: ",$Basics.toString(_p27._0._0)),
                 {ctor: "_Tuple2",_0: model,_1: $Effects.none});
              }
      ...
      _U.list([function () {
                 ...
                 if (_p11.ctor === "Nothing") {
                       ...
                       _U.list([A2($Html.button,
                               ...
                               _U.list([A2($Html.button,
                               _U.list([$Html$Attributes.$class("build-action fr"),$Html$Attributes.disabled(_p12.disableManualTrigger)]),
                               _U.list([A2($Html.i,_U.list([$Html$Attributes.$class("fa fa-plus-circle")]),_U.list([]))]))]))
