...
Elm.StepTree.make = function (_elm) {
   ...
   var getMultiStepIndex = F2(function (idx,tree) {
      var steps = function () {
         ...
         {case "Aggregate": return _p1._0;
            ...
            case "Retry": return _p1._1;
            default: return _U.crashCase("StepTree",{start: {line: 404,column: 7},end: {line: 415,column: 35}},_p1)("impossible");}
      }();
      var _p3 = A2($Array.get,idx,steps);
      if (_p3.ctor === "Just") {
            return _p3._0;
         } else {
            return _U.crashCase("StepTree",{start: {line: 417,column: 5},end: {line: 422,column: 33}},_p3)("impossible");
         }
   });
   var getHook = function (tree) {
      ...
      {case "OnSuccess": return _p5._0.hook;
         ...
         default: return _U.crashCase("StepTree",{start: {line: 372,column: 3},end: {line: 383,column: 31}},_p5)("impossible");}
   };
   var getStep = function (tree) {
      var _p7 = tree;
      switch (_p7.ctor)
      {case "OnSuccess": return _p7._0.step;
         case "OnFailure": return _p7._0.step;
         case "Ensure": return _p7._0.step;
         case "Try": return _p7._0;
         case "Timeout": return _p7._0;
         default: return _U.crashCase("StepTree",{start: {line: 326,column: 3},end: {line: 343,column: 31}},_p7)("impossible");}
   };
   var updateAt = F3(function (id,update,root) {
      var _p9 = A2($Dict.get,id,root.foci);
      if (_p9.ctor === "Nothing") {
            return _U.crashCase("StepTree",{start: {line: 248,column: 3},end: {line: 253,column: 60}},_p9)(A2($Basics._op["++"],
            "updateAt: id ",
            A2($Basics._op["++"],id," not found")));
         } else {
            return _U.update(root,{tree: A3($Focus.update,_p9._0,update,root.tree)});
         }
   });
   var isFirstOccurrence = F2(function (resources,step) {
      isFirstOccurrence: while (true) {
         ...
         if (_p11.ctor === "[]") {
               ...
               if (_U.eq(_p11._0.name,step)) return _p11._0.firstOccurrence; else {
                     var _v7 = _p11._1,_v8 = step;
                     resources = _v7;
                     step = _v8;
   ...
   var stepIsActive = function (_p12) {    return isActive(function (_) {    return _.state;}(_p12));};
   var treeIsActive = function (tree) {
      treeIsActive: while (true) {
         var _p13 = tree;
         switch (_p13.ctor)
         {case "Aggregate": return A2($List.any,treeIsActive,$Array.toList(_p13._0));
            case "Do": return A2($List.any,treeIsActive,$Array.toList(_p13._0));
            case "OnSuccess": var _v10 = _p13._0.step;
              tree = _v10;
              continue treeIsActive;
            case "OnFailure": var _v11 = _p13._0.step;
              tree = _v11;
              continue treeIsActive;
            case "Ensure": var _v12 = _p13._0.step;
              tree = _v12;
              continue treeIsActive;
            case "Try": var _v13 = _p13._0;
              tree = _v13;
              continue treeIsActive;
            case "Timeout": var _v14 = _p13._0;
              tree = _v14;
              continue treeIsActive;
            case "Retry": return A2($List.any,treeIsActive,$Array.toList(_p13._1));
            case "Task": return stepIsActive(_p13._0);
            case "Get": return stepIsActive(_p13._0);
            case "Put": return stepIsActive(_p13._0);
            default: return stepIsActive(_p13._0);}
      }
   };
   var autoExpanded = function (state) {    return isActive(state) && !_U.eq(state,StepStateSucceeded);};
   var toggleExpanded = function (_p14) {    var _p15 = _p14;return $Maybe.Just($Basics.not(A2($Maybe.withDefault,autoExpanded(_p15.state),_p15.expanded)));};
   ...
   var viewStep = F4(function (actions,model,_p16,icon) {
      var _p17 = _p16;
      var _p22 = _p17.state;
      var _p21 = _p17.expanded;
      return A2($Html.div,
      _U.list([$Html$Attributes.classList(_U.list([{ctor: "_Tuple2",_0: "build-step",_1: true}
                                                  ,{ctor: "_Tuple2",_0: "inactive",_1: $Basics.not(isActive(_p22))}
                                                  ,{ctor: "_Tuple2",_0: "first-occurrence",_1: _p17.firstOccurrence}]))]),
      _U.list([A2($Html.div,
              _U.list([$Html$Attributes.$class("header"),A2($Html$Events.onClick,actions,ToggleStep(_p17.id))]),
              _U.list([A2(viewStepState,_p22,model.finished)
                      ,typeIcon(icon)
                      ,$DictView.view(A2($Maybe.withDefault,$Dict.empty,_p17.version))
                      ,A2($Html.h3,_U.list([]),_U.list([$Html.text(_p17.name)]))]))
              ,A2($Html.div,
              _U.list([$Html$Attributes.classList(_U.list([{ctor: "_Tuple2",_0: "step-body",_1: true}
                                                          ,{ctor: "_Tuple2",_0: "clearfix",_1: true}
                                                          ,{ctor: "_Tuple2"
                                                           ,_0: "step-collapsed"
                                                           ,_1: $Basics.not(A2($Maybe.withDefault,autoExpanded(_p22),_p21))}]))]),
              A2($Maybe.withDefault,autoExpanded(_p22),A2($Maybe.map,$Basics.always(true),_p21)) ? _U.list([$DictView.view($Dict.fromList(A2($List.map,
                                                                                                           function (_p18) {
                                                                                                              var _p19 = _p18;
                                                                                                              return {ctor: "_Tuple2"
                                                                                                                     ,_0: _p19.name
   ...
   var viewTree = F3(function (actions,model,tree) {
      viewTree: while (true) {
         var _p23 = tree;
         switch (_p23.ctor)
         {case "Task": return A4(viewStep,actions,model,_p23._0,"fa-terminal");
            case "Get": return A4(viewStep,actions,model,_p23._0,"fa-arrow-down");
            case "DependentGet": return A4(viewStep,actions,model,_p23._0,"fa-arrow-down");
            case "Put": return A4(viewStep,actions,model,_p23._0,"fa-arrow-up");
            case "Try": var _v20 = actions,_v21 = model,_v22 = _p23._0;
              actions = _v20;
              model = _v21;
              tree = _v22;
              continue viewTree;
            case "Retry": var _p27 = _p23._2;
              var _p26 = _p23._1;
              return A2($Html.div,
              _U.list([$Html$Attributes.$class("retry")]),
              _U.list([A2($Html.ul,_U.list([$Html$Attributes.$class("retry-tabs")]),$Array.toList(A2($Array.indexedMap,A3(viewTab,actions,_p23._0,_p27),_p26)))
                      ,function () {
                         var _p24 = A2($Array.get,_p27 - 1,_p26);
                         if (_p24.ctor === "Just") {
                               return A3(viewTree,actions,model,_p24._0);
                            } else {
                               return _U.crashCase("StepTree",
                               {start: {line: 471,column: 11},end: {line: 475,column: 60}},
                               _p24)("impossible (bogus tab selected)");
                            }
                      }()]));
            case "Timeout": var _v24 = actions,_v25 = model,_v26 = _p23._0;
              actions = _v24;
              model = _v25;
              tree = _v26;
              continue viewTree;
            case "Aggregate": return A2($Html.div,
              ...
              $Array.toList(A2($Array.map,A2(viewSeq,actions,model),_p23._0)));
            case "Do": return A2($Html.div,_U.list([$Html$Attributes.$class("do")]),$Array.toList(A2($Array.map,A2(viewSeq,actions,model),_p23._0)));
            case "OnSuccess": return A5(viewHooked,"success",actions,model,_p23._0.step,_p23._0.hook);
            case "OnFailure": return A5(viewHooked,"failure",actions,model,_p23._0.step,_p23._0.hook);
            default: return A5(viewHooked,"ensure",actions,model,_p23._0.step,_p23._0.hook);}
      }
   });
   ...
   var focusRetry = F2(function (tab,tree) {
      var _p28 = tree;
      if (_p28.ctor === "Retry") {
            return A4(Retry,_p28._0,_p28._1,tab,User);
         } else {
            return _U.crashCase("StepTree",{start: {line: 239,column: 3},end: {line: 244,column: 53}},_p28)("impossible (non-retry tab focus)");
         }
   });
   var Try = function (a) {    return {ctor: "Try",_0: a};};
   var Ensure = function (a) {    return {ctor: "Ensure",_0: a};};
   ...
   var updateStep = F2(function (update,tree) {
      var _p30 = tree;
      switch (_p30.ctor)
      {case "OnSuccess": var _p31 = _p30._0;
           return OnSuccess(_U.update(_p31,{step: update(_p31.step)}));
         case "OnFailure": var _p32 = _p30._0;
           return OnFailure(_U.update(_p32,{step: update(_p32.step)}));
         case "Ensure": var _p33 = _p30._0;
           return Ensure(_U.update(_p33,{step: update(_p33.step)}));
         case "Try": return Try(update(_p30._0));
         case "Timeout": return Timeout(update(_p30._0));
         default: return _U.crashCase("StepTree",{start: {line: 347,column: 3},end: {line: 364,column: 31}},_p30)("impossible");}
   });
   ...
   var updateHook = F2(function (update,tree) {
      var _p35 = tree;
      switch (_p35.ctor)
      {case "OnSuccess": var _p36 = _p35._0;
           return OnSuccess(_U.update(_p36,{hook: update(_p36.hook)}));
         case "OnFailure": var _p37 = _p35._0;
           return OnFailure(_U.update(_p37,{hook: update(_p37.hook)}));
         case "Ensure": var _p38 = _p35._0;
           return Ensure(_U.update(_p38,{hook: update(_p38.hook)}));
         default: return _U.crashCase("StepTree",{start: {line: 387,column: 3},end: {line: 398,column: 31}},_p35)("impossible");}
   });
   ...
   var setMultiStepIndex = F3(function (idx,update,tree) {
      var _p40 = tree;
      switch (_p40.ctor)
      {case "Aggregate": return Aggregate(A3($Array.set,idx,update(A2(getMultiStepIndex,idx,tree)),_p40._0));
         case "Do": return Do(A3($Array.set,idx,update(A2(getMultiStepIndex,idx,tree)),_p40._0));
         case "Retry": var _p42 = _p40._0;
           var updatedSteps = A3($Array.set,idx,update(A2(getMultiStepIndex,idx,tree)),_p40._1);
           var _p41 = _p40._3;
           if (_p41.ctor === "Auto") {
                 return A4(Retry,_p42,updatedSteps,idx + 1,Auto);
              } else {
                 return A4(Retry,_p42,updatedSteps,_p40._2,User);
              }
         default: return _U.crashCase("StepTree",{start: {line: 426,column: 3},end: {line: 444,column: 31}},_p40)("impossible");}
   });
   var wrapMultiStep = function (i) {
      return $Dict.map(F2(function (_p44,focus) {    return A2($Focus._op["=>"],A2($Focus.create,getMultiStepIndex(i),setMultiStepIndex(i)),focus);}));
   };
   var DependentGet = function (a) {    return {ctor: "DependentGet",_0: a};};
   var Put = function (a) {    return {ctor: "Put",_0: a};};
   ...
   var init = F2(function (resources,plan) {
      var _p45 = plan.step;
      switch (_p45.ctor)
      {case "Task": return A3(initBottom,Task,plan.id,_p45._0);
         case "Get": var _p47 = _p45._0;
           return A3(initBottom,function (_p46) {    return Get(A4(setupGetStep,resources,_p47,_p45._1,_p46));},plan.id,_p47);
         case "Put": return A3(initBottom,Put,plan.id,_p45._0);
         case "DependentGet": return A3(initBottom,DependentGet,plan.id,_p45._0);
         case "Aggregate": var inited = A2($Array.map,init(resources),_p45._0);
         ...
         case "Do": var inited = A2($Array.map,init(resources),_p45._0);
           var trees = A2($Array.map,function (_) {    return _.tree;},inited);
           var subFoci = A2($Array.map,function (_) {    return _.foci;},inited);
           var wrappedSubFoci = A2($Array.indexedMap,wrapMultiStep,subFoci);
           var foci = A3($Array.foldr,$Dict.union,$Dict.empty,wrappedSubFoci);
           return A3(Model,Do(trees),foci,false);
         case "OnSuccess": return A3(initHookedStep,resources,OnSuccess,_p45._0);
         case "OnFailure": return A3(initHookedStep,resources,OnFailure,_p45._0);
         case "Ensure": return A3(initHookedStep,resources,Ensure,_p45._0);
         case "Try": return A3(initWrappedStep,resources,Try,_p45._0);
         case "Retry": var selfFoci = A2($Dict.singleton,plan.id,A2($Focus.create,$Basics.identity,$Basics.identity));
           var inited = A2($Array.map,init(resources),_p45._0);
           var trees = A2($Array.map,function (_) {    return _.tree;},inited);
           var subFoci = A2($Array.map,function (_) {    return _.foci;},inited);
           var wrappedSubFoci = A2($Array.indexedMap,wrapMultiStep,subFoci);
           var foci = A3($Array.foldr,$Dict.union,selfFoci,wrappedSubFoci);
           return A3(Model,A4(Retry,plan.id,trees,1,Auto),foci,false);
         default: return A3(initWrappedStep,resources,Timeout,_p45._0);}
   });
   ...
   var initWrappedStep = F3(function (resources,create,plan) {
      var _p48 = A2(init,resources,plan);
      var tree = _p48.tree;
      var foci = _p48.foci;
   ...
   var map = F2(function (f,tree) {
      var _p49 = tree;
      switch (_p49.ctor)
      {case "Task": return Task(f(_p49._0));
         case "Get": return Get(f(_p49._0));
         case "Put": return Put(f(_p49._0));
         case "DependentGet": return DependentGet(f(_p49._0));
         default: return tree;}
   });
   var update = F2(function (action,root) {
      var _p50 = action;
      switch (_p50.ctor)
      {case "ToggleStep": return A3(updateAt,_p50._0,map(function (step) {    return _U.update(step,{expanded: toggleExpanded(step)});}),root);
         case "Finished": return _U.update(root,{finished: true});
         default: return A3(updateAt,_p50._0,focusRetry(_p50._1),root);}
   });
...
Elm.Job.make = function (_elm) {
   ...
   var viewBuildOutputs = F2(function (model,bo) {
      ...
      _U.list([A2($Html.td,_U.list([$Html$Attributes.$class("resource-name mrm")]),_U.list([$Html.text(bo.resource)]))
              ,A2($Html.td,_U.list([$Html$Attributes.$class("resource-version")]),_U.list([$DictView.view(bo.version)]))]));
   });
   var viewBuildInputs = F2(function (model,bi) {
      ...
      _U.list([A2($Html.td,_U.list([$Html$Attributes.$class("resource-name mrm")]),_U.list([$Html.text(bi.resource)]))
              ,A2($Html.td,_U.list([$Html$Attributes.$class("resource-version")]),_U.list([$DictView.view(bi.version)]))]));
   });
   ...
   var viewPaginationBar = function (model) {
      ...
      _U.list([function () {
                 var _p1 = model.pagination.previousPage;
                 if (_p1.ctor === "Nothing") {
                       return A2($Html.div,
                       ...
                       _U.list([$Html$Attributes.$class("arrow")
                               ...
                               A2($Basics._op["++"],"/jobs/",A2($Basics._op["++"],model.jobInfo.name,A2($Basics._op["++"],"?",paginationParam(_p1._0)))))))]),
                       _U.list([A2($Html.i,_U.list([$Html$Attributes.$class("fa fa-arrow-left")]),_U.list([]))]))]));
                    }
              }()
              ,function () {
                 var _p2 = model.pagination.nextPage;
                 if (_p2.ctor === "Nothing") {
                       return A2($Html.div,
                       _U.list([$Html$Attributes.$class("btn-page-link disabled")]),
                       _U.list([A2($Html.span,
                       ...
                       _U.list([$Html$Attributes.$class("arrow")
                               ...
                               A2($Basics._op["++"],
                               model.jobInfo.pipelineName,
                               A2($Basics._op["++"],"/jobs/",A2($Basics._op["++"],model.jobInfo.name,A2($Basics._op["++"],"?",paginationParam(_p2._0)))))))]),
                       _U.list([A2($Html.i,_U.list([$Html$Attributes.$class("fa fa-arrow-right")]),_U.list([]))]))]));
                    }
              }()]));
   };
   var headerBuildStatusClass = function (finishedBuild) {
      ...
      if (_p3.ctor === "Nothing") {
            ...
            return $Concourse$BuildStatus.show(_p3._0.status);
         }
   };
   ...
   var viewBuildResources = F2(function (model,buildWithResources) {
      var outputsTable = function () {
         var _p4 = buildWithResources;
         if (_p4.ctor === "Nothing") {
               return loadSpinner;
            } else {
               return A2($Html.table,_U.list([$Html$Attributes.$class("build-resources")]),A2($List.map,viewBuildOutputs(model),_p4._0.resources.outputs));
            }
      }();
      var inputsTable = function () {
         var _p5 = buildWithResources;
         if (_p5.ctor === "Nothing") {
               return loadSpinner;
            } else {
               return A2($Html.table,_U.list([$Html$Attributes.$class("build-resources")]),A2($List.map,viewBuildInputs(model),_p5._0.resources.inputs));
            }
      }();
   ...
   var viewBuildWithResources = F2(function (model,lubwr) {
      ...
      function () {
         ...
         var build = function () {
            var _p6 = lubwr.buildWithResources;
            if (_p6.ctor === "Nothing") {
   ...
   var permalink = function (builds) {
      ...
      if (_p8.ctor === "Nothing") {
            ...
            return {direction: $Concourse$Pagination.Since(_p8._0.id + 1),limit: $List.length(builds)};
         }
   };
   ...
   var view = F2(function (actions,model) {
      ...
      _U.list([function () {
                 ...
                 if (_p9.ctor === "Nothing") {
                       ...
                       var _p10 = _p9._0;
                       return A2($Html.div,
                       _U.list([$Html$Attributes.id("page-header"),$Html$Attributes.$class(headerBuildStatusClass(_p10.finishedBuild))]),
                       _U.list([A2($Html.div,
                       _U.list([$Html$Attributes.$class("build-header")]),
                       _U.list([A2($Html.button,
                               A2($List.append,
                               _U.list([$Html$Attributes.id("job-state")
                                       ,$Html$Attributes.$class(A2($Basics._op["++"],"btn-pause btn-large fl ",A2(getPausedState,_p10,model.pausedChanging)))]),
                               $Basics.not(model.pausedChanging) ? _U.list([A2($Html$Events.onClick,actions,TogglePaused)]) : _U.list([])),
                               _U.list([A2($Html.i,
                               _U.list([$Html$Attributes.$class(A2($Basics._op["++"],"fa fa-fw fa-play ",A2(getPlayPauseLoadIcon,_p10,model.pausedChanging)))]),
                               _U.list([]))]))
                               ,A2($Html.form,
              ...
              ,function () {
                 ...
                 if (_p11.ctor === "Nothing") {
                       ...
                       _U.list([A2($Html.div,
                               ...
                               A2($List.map,viewBuildWithResources(model),$Array.toList(_p11._0)))
      ...
      return {ctor: "_Tuple2"
             ...
             {buildsWithResources: $Maybe.Just(function () {
                ...
                if (_p12.ctor === "Nothing") {
                      ...
                      return A2($Array.indexedMap,addNextBuildFromArray(fetchedBuilds),_p12._0);
                   }
             }())
             ,page: newPage
             ...
             function () {
                ...
                if (_p13.ctor === "Nothing") {
                      ...
                      return A2($Array.filter,isRunning,A2($Array.map,function (_) {    return _.nextBuild;},_p13._0));
                   }
             }())))))};
   });
   var Noop = {ctor: "Noop"};
   ...
   var update = F2(function (action,model) {
      ...
      {case "Noop": return {ctor: "_Tuple2",_0: model,_1: $Effects.none};
         case "JobBuildsFetched": if (_p14._0.ctor === "Ok") {
                 ...
                 return A2($Debug.log,
                 A2($Basics._op["++"],"failed to fetch builds: ",$Basics.toString(_p14._0._0)),
                 {ctor: "_Tuple2",_0: model,_1: $Effects.none});
              }
         case "JobFetched": if (_p14._0.ctor === "Ok") {
                 return {ctor: "_Tuple2",_0: _U.update(model,{job: $Maybe.Just(_p14._0._0)}),_1: A2(fetchJob,5 * $Time.second,model.jobInfo)};
              } else {
                 return A2($Debug.log,
                 A2($Basics._op["++"],"failed to fetch job info: ",$Basics.toString(_p14._0._0)),
                 {ctor: "_Tuple2",_0: model,_1: $Effects.none});
              }
           ...
           if (_p15.ctor === "Ok") {
                 ...
                 if (_p16.ctor === "Nothing") {
                       ...
                       if (_p17.ctor === "Nothing") {
                             ...
                             return {ctor: "_Tuple2"
                                    ,_0: _U.update(model,
                                    {buildsWithResources: $Maybe.Just(A3($Array.set,_p19.index,A2(addFetchedResources,_p15._0,_p17._0),_p18))})
                                    ,_1: $Effects.none};
                          }
                    }
              } else {
         ...
         case "ClockTick": return {ctor: "_Tuple2",_0: _U.update(model,{now: _p14._0}),_1: $Effects.none};
         case "TogglePaused": var _p20 = model.job;
           if (_p20.ctor === "Nothing") {
                 ...
                 var _p21 = _p20._0;
                 return {ctor: "_Tuple2"
                        ,_0: _U.update(model,{pausedChanging: true,job: $Maybe.Just(_U.update(_p21,{paused: $Basics.not(_p21.paused)}))})
         ...
         default: if (_p14._0.ctor === "Ok") {
                 ...
                 if (_p14._0._0.ctor === "BadResponse" && _p14._0._0._0 === 401) {
                       ...
                       return A2($Debug.log,
                       A2($Basics._op["++"],"failed to pause/unpause job: ",$Basics.toString(_p14._0._0)),
                       {ctor: "_Tuple2",_0: model,_1: $Effects.none});
                    }
              }}
   });
