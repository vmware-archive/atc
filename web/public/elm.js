...
Elm.Ansi.Log.make = function (_elm) {
   ...
   $String = Elm.String.make(_elm);
   var _op = {};
   var lineLen = function (line) {
      var _p0 = line;
      if (_p0.ctor === "[]") {
            return 0;
         } else {
            return $String.length(_p0._0.text) + lineLen(_p0._1);
         }
   };
   var takeLen = F2(function (len,line) {
      if (_U.eq(len,0)) return _U.list([]); else {
            ...
            if (_p1.ctor === "::") {
                  ...
                  return _U.cmp(chunkLen,len) < 0 ? A2($List._op["::"],
                  _p2,
                  A2(takeLen,len - chunkLen,_p1._1)) : _U.list([_U.update(_p2,
      ...
      dropLen: while (true) {
         ...
         if (_p3.ctor === "::") {
               ...
               if (_U.cmp(chunkLen,len) > 0) return A2($List._op["::"],
                  _U.update(_p4,{text: A2($String.dropLeft,len,_p4.text)}),
                  _p5); else {
   ...
   var appendLine = F3(function (after,line,lines) {
      ...
      return A2($Array.push,line,lines); else {
            var _v6 = after - 1,
            _v7 = line,
            _v8 = A2($Array.push,_U.list([]),lines);
            after = _v6;
            line = _v7;
            lines = _v8;
            continue appendLine;
   ...
   var handleAction = F2(function (action,model) {
      ...
      {case "Print": var _p8 = _p7._0;
           ...
           _U.list([]),
           A2($Array.get,model.position.row,model.lines));
           var chunk = A2(Chunk,_p8,model.style);
           var line = A3(writeChunk,
           model.position.column,
           chunk,
           lineToChange);
           return _U.update(model,
           {lines: A3(setLine,model.position.row,line,model.lines)
         ...
         case "CursorDown": return _U.update(model,
           {position: A3(moveCursor,_p7._0,0,model.position)});
         case "CursorForward": return _U.update(model,
           {position: A3(moveCursor,0,_p7._0,model.position)});
         ...
         case "EraseLine": var _p10 = _p7._0;
           ...
           {case "EraseToBeginning":
              var lineToChange = A2($Maybe.withDefault,
                ...
                return _U.update(model,
                {lines: A3(setLine,model.position.row,line,model.lines)});
              case "EraseToEnd": var lineToChange = A2($Maybe.withDefault,
                _U.list([]),
                A2($Array.get,model.position.row,model.lines));
...
Elm.BuildEvent.make = function (_elm) {
   ...
   var Origin = F4(function (a,b,c,d) {
      return {stepName: a,stepType: b,source: c,id: d};
   });
   ...
   var BuildStatus = function (a) {
      return {ctor: "BuildStatus",_0: a};
   };
   var decodeEvent = function (e) {
      var _p2 = e.event;
      switch (_p2)
      {case "status": return A2($Json$Decode.decodeValue,
           A2($Json$Decode.object1,BuildStatus,decodeStatus),
           e.value);
...
Elm.BuildPlan.make = function (_elm) {
   ...
   $Json$Decode.oneOf(_U.list([A2($Json$Decode._op[":="],
                              ...
                              ,A2($Json$Decode._op[":="],
                              "on_success",
                              lazy(function (_p5) {    return decodeOnSuccess;}))
                              ,A2($Json$Decode._op[":="],
                              "on_failure",
                              lazy(function (_p6) {    return decodeOnFailure;}))
                              ,A2($Json$Decode._op[":="],
                              "ensure",
                              lazy(function (_p7) {    return decodeEnsure;}))
                              ,A2($Json$Decode._op[":="],
                              "try",
                              lazy(function (_p8) {    return decodeTry;}))
                              ,A2($Json$Decode._op[":="],
                              "timeout",
                              lazy(function (_p9) {    return decodeTimeout;}))])));
   var decodeAggregate = A2($Json$Decode.object1,
   Aggregate,
   $Json$Decode.array(lazy(function (_p10) {
      return decodePlan;
   })));
   ...
   A2($Json$Decode._op[":="],
   "step",
   lazy(function (_p11) {    return decodePlan;})),
   A2($Json$Decode._op[":="],
   "ensure",
   lazy(function (_p12) {    return decodePlan;}))));
   ...
   A2($Json$Decode._op[":="],
   "step",
   lazy(function (_p13) {    return decodePlan;})),
   A2($Json$Decode._op[":="],
   "on_failure",
...
Elm.StepTree.make = function (_elm) {
   ...
   var viewStepLog = function (window) {
      return A2($Html.pre,
      _U.list([]),
      $Array.toList(A2($Array.map,lazyLine,window.lines)));
   };
...
Elm.Build.make = function (_elm) {
   ...
   var toStatus = function (str) {
      ...
      {case "started": return $BuildEvent.BuildStatusStarted;
         ...
         default: return _U.crashCase("Build",
           {start: {line: 387,column: 3},end: {line: 393,column: 48}},
   ...
   var viewBuildHeader = F3(function (actions,build,status) {
      ...
      _U.list([$Html$Attributes.id("page-header")
              ,$Html$Attributes.$class(statusClass(A2($Maybe.withDefault,
              ...
              _U.list([A2($Html.div,
                      ...
                      _U.list([A2($Html.form,
                              _U.list([$Html$Attributes.$class("trigger-build")
                                      ...
                                      A2($Basics._op["++"],
                                      "/jobs/",
                                      A2($Basics._op["++"],build.jobName,"/builds")))))]),
   ...
   var view = F2(function (actions,model) {
      ...
      if (_p3.ctor === "_Tuple2" && _p3._0.ctor === "Just") {
            if (_p3._1.ctor === "Just") {
                  return A2($Html.div,
                  _U.list([]),
                  _U.list([A3(viewBuildHeader,actions,_p3._0._0,model.status)
                          ,A2($Html.div,
                          ...
                          _p3._1._0.tree)])) : $Html.text("loading...")]))]));
               } else {
                  return A2($Html.div,
                  _U.list([]),
                  _U.list([A3(viewBuildHeader,actions,_p3._0._0,model.status)
   ...
   var ScrollFromBottom = function (a) {
   ...
   var update = F2(function (action,model) {
      ...
      {case "Noop": return {ctor: "_Tuple2"
         ...
         return $Basics.not(model.eventsLoaded) && model.autoScroll ? {ctor: "_Tuple2"
                                                                      ...
                                                                      ,_1: $Effects.batch(_U.list([keepScrolling
                                                                                                  ,scrollToBottom]))} : {ctor: "_Tuple2"
                                                                                                                        ,_0: model
                                                                                                                        ,_1: $Effects.none};
         case "ScrollFromBottom": return _U.eq(_p6._0,
           0) ? {ctor: "_Tuple2"
         ...
         case "PlanFetched": if (_p6._0.ctor === "Err") {
                 if (_p6._0._0.ctor === "BadResponse" && _p6._0._0._0 === 404)
                 {
                       return {ctor: "_Tuple2"
                              ,_0: model
                       ...
                       $Basics.toString(_p6._0._0)),
                       {ctor: "_Tuple2",_0: model,_1: $Effects.none});
                    }
              } else {
                 return {ctor: "_Tuple2"
                        ,_0: _U.update(model,
                        {stepRoot: $Maybe.Just($StepTree.init(_p6._0._0))})
                        ,_1: A2(subscribeToEvents,model.buildId,model.actions)};
              }
         case "BuildFetched": if (_p6._0.ctor === "Err") {
                 return A2($Debug.log,
                 A2($Basics._op["++"],
                 ...
                 var _p8 = _p6._0._0;
                 var status = toStatus(_p8.status);
                 ...
                 return {ctor: "_Tuple2"
                        ,_0: _U.update(model,
                        {build: $Maybe.Just(_p8)
                        ,status: $Maybe.Just(status)
                        ,buildRunning: running})
                        ,_1: $Effects.none};
              }
         case "Listening": return {ctor: "_Tuple2"
                                  ,_0: _U.update(model,{eventSource: $Maybe.Just(_p6._0)})
                                  ,_1: $Effects.none};
         ...
         case "Errored": return {ctor: "_Tuple2"
                                ,_0: model
                                ,_1: $Effects.none};
         case "Event": if (_p6._0.ctor === "Ok") {
                 switch (_p6._0._0.ctor)
                 {case "Log": return {ctor: "_Tuple2"
                                     ,_0: A3(updateStep,
                                     _p6._0._0._0.id,
                                     function (_p9) {
                                        return setRunning(A2(appendStepLog,_p6._0._0._1,_p9));
                                     },
                                     model)
                                     ,_1: $Effects.none};
                    case "Error": return {ctor: "_Tuple2"
                                         ...
                                         _p6._0._0._0.id,
                                         function (_p10) {
                                            return setRunning(A2(setStepError,_p6._0._0._1,_p10));
                                         },
                                         model)
                                         ,_1: $Effects.none};
                    case "InitializeTask": return {ctor: "_Tuple2"
                                                  ,_0: A3(updateStep,_p6._0._0._0.id,setRunning,model)
                                                  ,_1: $Effects.none};
                    ...
                    default: return {ctor: "_Tuple2"
                                    ...
                                    {status: $Maybe.Just(_p6._0._0._0)}) : model
                                    ,_1: $Effects.none};}
              } else {
                 return {ctor: "_Tuple2"
                        ,_0: model
                        ,_1: A2($Debug.log,_p6._0._0,$Effects.none)};
              }
         case "StepTreeAction": return {ctor: "_Tuple2"
                                       ,_0: _U.update(model,
                                       {stepRoot: A2($Maybe.map,
                                       $StepTree.update(_p6._0),
                                       model.stepRoot)})
                                       ,_1: $Effects.none};
         case "EndOfEvents": var _p11 = model.eventSource;
           if (_p11.ctor === "Just") {
                 return {ctor: "_Tuple2"
...
Elm.Main.make = function (_elm) {
   ...
   var app = function () {
      ...
      return $StartApp.start({init: A2($Build.init,
                             pageDrivenActions.address,
                             buildId)
                             ,update: $Build.update
                             ,view: $Build.view
                             ,inputs: _U.list([pageDrivenActions.signal
                                              ,A2($Signal.map,$Build.ScrollFromBottom,$Scroll.fromBottom)])});
   }();
   var main = app.html;
