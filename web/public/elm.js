...
Elm.Build.make = function (_elm) {
   ...
   var viewBuildPrepInput = function (_p2) {
      var _p3 = _p2;
      return A2(viewBuildPrepLi,A2($Basics._op["++"],"discovering any new versions of ",_p3._0),_p3._1);
   };
   ...
   var viewBuildPrep = function (prep) {
      ...
      if (_p4.ctor === "Just") {
            ...
            _U.list([A2($Html.div,
                    ...
                    A2($Basics._op["++"],
                    _U.list([A2(viewBuildPrepLi,"checking pipeline is not paused",_p5.pausedPipeline)
                            ,A2(viewBuildPrepLi,"checking job is not paused",_p5.pausedJob)]),
                    A2($Basics._op["++"],
                    viewBuildPrepInputs(_p5.inputs),
                    _U.list([A2(viewBuildPrepLi,"waiting for a suitable set of input versions",_p5.inputsSatisfied)
                            ,A2(viewBuildPrepLi,"checking max-in-flight is not reached",_p5.maxRunningBuilds)]))))]))]));
         } else {
            return A2($Html.div,_U.list([]),_U.list([]));
         }
   };
   ...
   var viewBuildHeader = F3(function (actions,build,_p8) {
      ...
      var buildTitle = function () {
         ...
         if (_p10.ctor === "Just") {
               ...
               "/pipelines/",
               A2($Basics._op["++"],_p10._0.pipelineName,A2($Basics._op["++"],"/jobs/",_p11))))]),
               _U.list([$Html.text(A2($Basics._op["++"],_p11,A2($Basics._op["++"]," #",build.name)))]));
            } else {
      ...
      var triggerButton = function () {
         ...
         if (_p12.ctor === "Just") {
               ...
               "/pipelines/",
               A2($Basics._op["++"],_p12._0.pipelineName,A2($Basics._op["++"],"/jobs/",A2($Basics._op["++"],_p12._0.name,"/builds"))));
               return A2($Html.form,
      ...
      return A2($Html.div,
      _U.list([$Html$Attributes.id("page-header"),$Html$Attributes.$class($Concourse$BuildStatus.show(_p14))]),
      _U.list([A2($Html.div,
   ...
   var viewBuildOutput = F2(function (actions,output) {
      var _p16 = output;
      if (_p16.ctor === "Just") {
            return A2($BuildOutput.view,A2($Signal.forwardTo,actions,BuildOutputAction),_p16._0);
         } else {
            return A2($Html.div,_U.list([]),_U.list([]));
         }
   });
