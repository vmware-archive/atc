...
Elm.Concourse.Job.make = function (_elm) {
   ...
   var init = F5(function (pipelineName,
   name,
   finishedBuild,
   maybePaused,
   ...
   var Job = F5(function (a,b,c,d,e) {
      return {name: a
             ,pipelineName: b
             ,finishedBuild: c
             ,paused: d
             ,disableManualTrigger: e};
   });
...
Elm.Build.make = function (_elm) {
   ...
   var mmDDYY = function (d) {
      ...
      A2($String.left,2,A2($Date$Format.format,"%Y",d)));
   };
...
Elm.JobPage.make = function (_elm) {
   ...
   var app = $StartApp.start({init: A5($Job.init,
                             redirects.address,
                             jobName,
                             pipelineName,
                             pageSince,
