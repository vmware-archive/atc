...
type ATCCommand struct {
	...
	ResourceCheckingInterval          time.Duration `long:"resource-checking-interval" default:"10s" description:"Interval on which to check for new versions of resources."`
