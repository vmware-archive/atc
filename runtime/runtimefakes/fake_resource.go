...
type FakeResource struct {
	...
	PutStub        func(context.Context, runtime.IOConfig, atc.Source, atc.Params) (resource.VersionedSource, error)
...
func (fake *FakeResource) Put(arg1 context.Context, arg2 runtime.IOConfig, arg3 atc.Source, arg4 atc.Params) (resource.VersionedSource, error) {
	fake.putMutex.Lock()
...
var _ runtime.Resource = new(FakeResource)
